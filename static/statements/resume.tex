...
\begin{minipage}[t]{0.72\textwidth}
    ...
    { 
        ...
        \begin{minipage}{0.4\textwidth}
            \small
            \icon{MapMarker}{11}{\textbf{Nationality:} Indian}\vspace{-2mm}\\
            \icon{Phone}{11}{(+91) 80139 76355}\vspace{-2mm}\\
            \icon{Envelope}{11}{\href{mailto:roysubhra98@gmail.com}{roysubhra98@gmail.com}}\vspace{-2mm}\\
        \end{minipage}
    ...
    {\textbf{CURRENT POSITIONS}\vspace{2mm}\\
        {
            \small
            \emph{External Research Fellow} pursuing Ph.D. in Statistics from \textbf{Indian Statistical Institute, Kolkata}\\
            \emph{Principal Information Researcher} at \textbf{SysCloud Inc.}            
        }
...
\begin{minipage}{0.27\textwidth}
    \vspace{0.75\baselineskip}  % Required for vertically aligning minipages
    {
        ...
        \icon{Github}{11}{\href{https://github.com/subroy13}{github.com/subroy13}}\vspace{-2mm}\\
        \icon{LinkedinSquare}{11}{\href{https://www.linkedin.com/in/subroy13}{/in/subroy13}}\vspace{-2mm}\\
...
\begin{minipage}[t]{0.42\textwidth}
    ...
    %     \small Statistics, Machine learning, Deep learning, Mathematics, Algorithms.
    % \end{minipage}
